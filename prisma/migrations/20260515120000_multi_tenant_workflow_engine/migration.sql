...
CREATE UNIQUE INDEX "workflows_tenant_id_key_version_key"
  ON "workflows"("tenant_id", "key", "version");

CREATE INDEX "workflows_tenant_id_key_status_idx"
...
CREATE UNIQUE INDEX "workflow_steps_workflow_id_key_key"
...
CREATE UNIQUE INDEX "workflow_transitions_workflow_id_from_step_id_name_key"
  ON "workflow_transitions"("workflow_id", "from_step_id", "name");

CREATE INDEX "workflow_transitions_workflow_id_idx"
...
CREATE INDEX "case_history_case_id_transitioned_at_idx"
...
CREATE UNIQUE INDEX "cases_tenant_id_case_number_key"
  ON "cases"("tenant_id", "case_number");

CREATE INDEX "cases_tenant_id_current_step_id_idx"
  ON "cases"("tenant_id", "current_step_id");

CREATE INDEX "cases_tenant_id_workflow_id_closed_at_idx"
  ON "cases"("tenant_id", "workflow_id", "closed_at");

CREATE INDEX "cases_originating_tenant_id_referral_status_idx"
...
ALTER TABLE "audit_logs" ADD COLUMN "related_tenant_id" UUID;
...
CREATE INDEX "audit_logs_related_tenant_id_idx" ON "audit_logs"("related_tenant_id");
CREATE INDEX "audit_logs_tenant_id_entity_type_entity_id_created_at_idx"
  ON "audit_logs"("tenant_id", "entity_type", "entity_id", "created_at");
CREATE INDEX "audit_logs_related_tenant_id_entity_type_entity_id_created_at_idx"
  ON "audit_logs"("related_tenant_id", "entity_type", "entity_id", "created_at");
CREATE INDEX "audit_logs_tenant_id_user_id_created_at_idx"
