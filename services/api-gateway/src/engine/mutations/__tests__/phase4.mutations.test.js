...
describe('updateCase mutation', () => {
  ...
  beforeEach(async () => {
    const mod = await import('../mutations/updateCase.mutation.js');
    execute = mod.execute;
    schema = mod.schema;
  });
...
describe('closeCase mutation', () => {
  ...
  beforeEach(async () => {
    const mod = await import('../mutations/closeCase.mutation.js');
    execute = mod.execute;
  });
...
describe('inviteUser mutation', () => {
  ...
  beforeEach(async () => {
    const mod = await import('../mutations/inviteUser.mutation.js');
    execute = mod.execute;
  });
...
describe('deactivateUser mutation', () => {
  ...
  beforeEach(async () => {
    const mod = await import('../mutations/deactivateUser.mutation.js');
    execute = mod.execute;
  });
...
describe('updateUser mutation', () => {
  ...
  beforeEach(async () => {
    const mod = await import('../mutations/updateUser.mutation.js');
    execute = mod.execute;
    schema = mod.schema;
  });
